...
namespace Starcounter.ErrorCodes.Generator {
    static class CommandLine {
        public static void ParseArgs(string[] args, 
                                     ref Stream instream,
                                     ref TextWriter csfile, 
                                     ref TextWriter mcfile, 
                                     ref TextWriter exceptionAssistantContentFile) {
        if (args.Length == 0) {
            PrintUsageAndExit();
        }
    ...
    private static void PrintUsageAndExit() {
        ...
        Console.Error.WriteLine("Starcounter.ErrorCodes.Compiler.exe infile.xml [options]");
